...
// document.addEventListener('DOMContentLoaded', function () {
//     // Функция для загрузки данных пользователя и его тестов
//     function loadUserData() {
//         fetch('../users/me') // Эндпоинт для получения данных пользователя
//             .then(response => response.json())
//             .then(data => {
//                 if (data) {
//                     const vacanciesSection = document.querySelector('.vacancies');
//                     vacanciesSection.innerHTML = ''; // Очищаем секцию
//
//                     // Проверяем наличие тестов у пользователя
...
//                         setupCardHandlers();
//                     } else {
//                         vacanciesSection.innerHTML = '<p>У вас нет созданных тестов.</p>';
//                     }
//                 } else {
